...
object ProtocolIds {
    ...
    const val PRIVATE_POST_SETTINGS_BLOCK = "/private/post/settings/block/0.0.0"
    const val PRIVATE_POST_SETTINGS_UNBLOCK = "/private/post/settings/unblock/0.0.0"
    const val PRIVATE_GET_SETTINGS_BLOCKS = "/private/get/settings/blocks/0.0.0"
    const val PRIVATE_POST_SETTINGS_MUTE = "/private/post/settings/mute/0.0.0"
    const val PRIVATE_POST_SETTINGS_UNMUTE = "/private/post/settings/unmute/0.0.0"
    const val PRIVATE_GET_SETTINGS_MUTES = "/private/get/settings/mutes/0.0.0"
    ...
    const val PRIVATE_POST_FOLLOW_REQUEST_AUTHORIZE = "/private/post/follow/request/authorize/0.0.0"
    const val PRIVATE_POST_FOLLOW_REQUEST_REJECT = "/private/post/follow/request/reject/0.0.0"
    const val PRIVATE_GET_SETTINGS_FILTER = "/private/get/settings/filter/0.0.0"
    const val PRIVATE_GET_SETTINGS_FILTERS = "/private/get/settings/filters/0.0.0"
    const val PRIVATE_POST_SETTINGS_FILTER = "/private/post/settings/filter/0.0.0"
    const val PRIVATE_POST_SETTINGS_FILTER_UPDATE = "/private/post/settings/filter/update/0.0.0"
    const val PRIVATE_DELETE_SETTINGS_FILTER = "/private/delete/settings/filter/0.0.0"
    const val PRIVATE_POST_SETTINGS_FILTER_KEYWORD = "/private/post/settings/filter/keyword/0.0.0"
    const val PRIVATE_POST_SETTINGS_FILTER_KEYWORD_UPDATE = "/private/post/settings/filter/keyword/update/0.0.0"
    const val PRIVATE_DELETE_SETTINGS_FILTER_KEYWORD = "/private/delete/settings/filter/keyword/0.0.0"
