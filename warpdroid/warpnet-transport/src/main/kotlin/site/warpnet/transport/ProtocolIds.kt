...
object ProtocolIds {
    ...
    const val PRIVATE_GET_NOTIFICATIONS_NEW = "/private/get/notifications/new/0.0.0"
    ...
    const val PRIVATE_GET_FILTER = "/private/get/filter/0.0.0"
    const val PRIVATE_GET_FILTERS = "/private/get/filters/0.0.0"
    const val PRIVATE_POST_FILTER = "/private/post/filter/0.0.0"
    const val PRIVATE_POST_FILTER_UPDATE = "/private/post/filter/update/0.0.0"
    const val PRIVATE_DELETE_FILTER = "/private/delete/filter/0.0.0"
    const val PRIVATE_POST_FILTER_KEYWORD = "/private/post/filter/keyword/0.0.0"
    const val PRIVATE_POST_FILTER_KEYWORD_UPDATE = "/private/post/filter/keyword/update/0.0.0"
    const val PRIVATE_DELETE_FILTER_KEYWORD = "/private/delete/filter/keyword/0.0.0"
