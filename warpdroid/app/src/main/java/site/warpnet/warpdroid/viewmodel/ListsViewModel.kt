...
import site.warpnet.warpdroid.util.replacedFirstWhich
import site.warpnet.warpdroid.util.withoutFirstWhich
...
@HiltViewModel
internal class ListsViewModel @Inject constructor(private val api: WarpnetApi) : ViewModel() {
