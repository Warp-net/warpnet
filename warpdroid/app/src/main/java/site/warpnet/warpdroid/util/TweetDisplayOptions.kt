...
data class TweetDisplayOptions(
    ...
    /**
     * @return a new TweetDisplayOptions adapted to whichever preference changed.
     */
    ...
    companion object {
        fun from(preferences: SharedPreferences, account: AccountEntity) = TweetDisplayOptions(
