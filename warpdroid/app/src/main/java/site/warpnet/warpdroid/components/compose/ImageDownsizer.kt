...
import site.warpnet.warpdroid.util.calculateInSampleSize
import site.warpnet.warpdroid.util.closeQuietly
import site.warpnet.warpdroid.util.getImageOrientation
import site.warpnet.warpdroid.util.reorientBitmap
import java.io.File
