...
class SearchTweetPagingSource(
    ...
    override fun getRefreshKey(state: PagingState<Int, TweetViewData.Concrete>): Int? = null

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, TweetViewData.Concrete> {
