...
import site.warpnet.warpdroid.json.Guarded
...
data class Tweet(
    ...
    fun toDeletedTweet(): DeletedTweet {
        return DeletedTweet(
    ...
    private fun getEditableText(): String {
        val contentSpanned = content.parseAsWarpnetHtml()
        val builder = SpannableStringBuilder(content.parseAsWarpnetHtml())
