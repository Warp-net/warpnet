...
import site.warpnet.warpdroid.MainActivity.Companion.redirectIntent
import site.warpnet.warpdroid.adapter.AccountSelectionAdapter
import site.warpnet.warpdroid.db.AccountManager
import site.warpnet.warpdroid.db.entity.AccountEntity
import site.warpnet.warpdroid.di.PreferencesEntryPoint
...
import site.warpnet.warpdroid.util.ActivityConstants
import site.warpnet.warpdroid.util.isBlack
import site.warpnet.warpdroid.util.overrideActivityTransitionCompat
...
abstract class BaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isBlack(resources.configuration, theme)) {
            setTheme(R.style.WarpdroidBlackTheme)
        } else if (this is MainActivity) {
            // Replace the SplashTheme of MainActivity
            setTheme(R.style.WarpdroidTheme)
        }
