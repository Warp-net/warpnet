...
package site.warpnet.warpdroid.components.trending.viewmodel
...
import site.warpnet.warpdroid.entity.end
import site.warpnet.warpdroid.entity.start
...
class TrendingTagsViewModel @Inject constructor(
    ...
    fun invalidate(refresh: Boolean = false) = viewModelScope.launch {
        ...
        val deferredFilters = async { warpnetApi.getFilters() }

        warpnetApi.trendingTags().fold(
            { tagResponse ->
