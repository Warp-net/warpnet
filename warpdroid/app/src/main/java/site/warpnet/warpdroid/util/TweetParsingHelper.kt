...
@file:JvmName("TweetParsingHelper")
...
/**
 * parse a String containing html from the Warpnet api to Spanned
 */
@JvmOverloads
fun String.parseAsWarpnetHtml(tagHandler: TagHandler? = warpdroidTagHandler): Spanned {
...
val warpdroidTagHandler = WarpdroidTagHandler()

open class WarpdroidTagHandler : TagHandler {
