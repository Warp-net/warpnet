...
import site.warpnet.warpdroid.databinding.FragmentAccountsInListBinding
...
import site.warpnet.warpdroid.viewmodel.AccountsInListViewModel
import site.warpnet.warpdroid.viewmodel.State
...
class AccountsInListFragment : DialogFragment() {
    ...
    override fun getTheme() = R.style.WarpdroidDialogFragment
