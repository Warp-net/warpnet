...
exclude github.com/ipfs/go-datastore v0.8.2

replace (
	github.com/armon/go-metrics => github.com/armon/go-metrics v0.4.1
	github.com/ipfs/go-datastore => github.com/ipfs/go-datastore v0.6.1
)

require (
	github.com/Masterminds/semver/v3 v3.3.1
	github.com/Warp-net/warpnet-frontend v0.0.567
